#!/usr/bin/env python3
"""
Script limpo para atualizar artigos sem scripts maliciosos ou redes suspeitas.
Versão segura para aprovação no Google AdSense.
"""
...
<body>
    ...
    <div class="container">
        ...
        <div class="ad-box">
            <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-4896859041377751" data-ad-slot="0000000000" data-ad-format="auto" data-full-width-responsive="true"></ins>
            <script>
...
print(f"✅ {len(articles)} artigos atualizados com conteúdo limpo e seguro para AdSense.")
